...
class Location(db.Model):
	...
	lga_id = db.Column(db.String, db.ForeignKey('lga.id'))
...
class Lga(db.Model):
	...
	state_id = db.Column(db.String(35), nullable=False)
...
class State(db.Model):
	...
	id = db.Column(db.String, primary_key=True)
	name = db.Column(db.String(35), nullable=False)
	country_id = db.Column(db.String(35), nullable=False)
...
class Country(db.Model):
	...
	id = db.Column(db.String, primary_key=True)
	name = db.Column(db.String(35), nullable=False)
	continent_id = db.Column(db.String(35), nullable=False)
